...
System.out.println("Hola después de instanciar Kevin1");
// Reproduce por el altavoz
//while (true)
//{
//voz.speak("auan babuluba balan bambu");
//voz.speak("Hello World");
//voice.speak("Hello World Hello WorldHello WorldHello WorldHello WorldHello World");
//}
//voz.speak("Text to Speech demo");
// Graba un fichero de audio con el contenido en el directorio
voz.toFile("ttsdemo.wav", "static public void main throws Exception ");
// Podriamos reproducir este fichero desde consola: $ mplayer ttsdemo.wav
// Cerramos
voz.close();
System.out.println("Hola después de instanciar Kevin2");
}
catch(Exception e)
{
e.printStackTrace();
